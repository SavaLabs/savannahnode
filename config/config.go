...
import (
	...
	"github.com/SavaLabs/savannahnode/chains"
	"github.com/SavaLabs/savannahnode/genesis"
	"github.com/SavaLabs/savannahnode/ids"
	"github.com/SavaLabs/savannahnode/ipcs"
	"github.com/SavaLabs/savannahnode/nat"
	"github.com/SavaLabs/savannahnode/network"
	"github.com/SavaLabs/savannahnode/network/dialer"
	"github.com/SavaLabs/savannahnode/network/throttling"
	"github.com/SavaLabs/savannahnode/node"
	...
	"github.com/SavaLabs/savannahnode/utils/dynamicip"
	"github.com/SavaLabs/savannahnode/utils/ips"
	"github.com/SavaLabs/savannahnode/utils/logging"
	"github.com/SavaLabs/savannahnode/utils/password"
	"github.com/SavaLabs/savannahnode/utils/perms"
	"github.com/SavaLabs/savannahnode/utils/profiler"
	"github.com/SavaLabs/savannahnode/utils/storage"
...
func getStakingConfig(v *viper.Viper, networkID uint32) (node.StakingConfig, error) {
	...
	if !config.EnableStaking && (networkID == constants.MainnetID || networkID == constants.FujiID || networkID == constants.SavannahID || networkID == constants.MarulaID) {
	...
	if networkID != constants.MainnetID && networkID != constants.FujiID && networkID != constants.SavannahID && networkID != constants.MarulaID {
